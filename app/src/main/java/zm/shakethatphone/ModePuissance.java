...
public class ModePuissance extends Activity implements SensorEventListener {
    ...
    private TextView viewBestScorePuissance;
    /**
     * Preferences
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewBestScorePuissance = (TextView) findViewById(R.id.bestScorePuissance);
        viewBestScorePuissance.setText(Integer.toString(memoireBestScorePuissance));
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if(bestPuissanceValue > memoireBestScorePuissance){
                    ...
                    editor.commit();
                    viewBestScorePuissance.setText(Integer.toString(bestPuissanceValue));
                }
